...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra_ingresada = prompt ("Verificación","ingrese una letra")
       
        
        while letra_ingresada != "U" or letra_ingresada != "T" or letra_ingresada != "N" :
            letra_ingresada = prompt ("Verificación","ingrese una letra")
            if letra_ingresada == "U" or letra_ingresada == "T" or letra_ingresada == "N":
                break

        alert (title= "Verificación", message= "Letra correcta")
