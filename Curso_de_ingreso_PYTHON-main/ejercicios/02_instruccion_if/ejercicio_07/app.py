...
los dieciocho (18) años están habilitados a votar. Al presionar el botón  'Calcular', se deberá informar 
(utilizando el Dialog Alert) si es o no posible que la persona concurra a votar en base a la información 
suministrada.
'''
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        tipo_txt =  self.combobox_tipo.get()
        mensaje = "NO PUEDE VOTAR"

        if edad_numero >= 16 and tipo_txt == "NATIVO" or edad_numero >= 18 and tipo_txt == "NATURALIZADO":
            mensaje="PUEDE VOTAR" 
        alert(title="DEBER CIVICO", message=mensaje)
