...
transformarlo en número y calcular si es mayor, niño/a(menor de 10) o pre-adolescente (edad entre 10
 y 13 años) o adolescente (edad entre 13 y 17 años) de edad, se deberá informar utilizando el Dialog alert.
'''
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if edad_numero >= 0 and edad_numero <= 9:
            mensaje = "NIÑO"
        ...
        alert("Rango etario", message=mensaje)
