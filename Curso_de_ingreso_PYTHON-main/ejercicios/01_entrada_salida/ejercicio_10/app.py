...
(txt_importe y txt_descuento), transformarlos en números y mostrar el importe actualizado con 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        descuento_pesos_numero = importe_numero * descuento_numero / 100

        Saldo_final = importe_numero - descuento_pesos_numero 
        alert("Precio Final", f"${Saldo_final} con descuento del {descuento_numero}%")
