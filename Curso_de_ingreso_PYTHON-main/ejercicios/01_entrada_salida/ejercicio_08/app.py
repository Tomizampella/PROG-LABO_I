...
(txtOperadorA y txtOperadorB),transformarlos en números enteros, calcular y mostrar el resto de la 
división utilizando el Dialog Alert. Ej: "El resto de dividir 7 por 2 es: 1" 
'''
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        alert("Resto", "El resto de dividir " + str(Dividiendo_numero_a) 
        + " por " + str(Dividiendo_numero_b) + " es: " + str(resultado))
