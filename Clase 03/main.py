...
def calcular_heroe_mas_alto_femenino ():
    ...
    print (f"El superhéroe más alto de genero femenino es {maxima_altura_f_nombre} \n")
...
def calcular_heroe_mas_alto_masculino ():
    ...
    print (f"El superhéroe más alto de genero masculino es {maxima_altura_m_nombre} \n")
...
def calcular_heroe_mas_debil_masculino ():
    ...
    print (f"El superhéroe más débil de genero masculino es {minima_fuerza_m_nombre} \n")
...
def calcular_heroe_mas_debil_no_binario ():
    ...
    if minima_fuerza_nb_nombre != None:
        print (f"El superhéroe más débil de genero no binario es {minima_fuerza_nb_nombre} \n")
...
def calcular_fuerza_promedio_genero_nb ():
    ...
    if contador_no_binario != 0: 
       ...
       print (f"La fuerza promedio de los superhéroes de genero no binario es {promedio_fuerza_nb :.0f} kg\n") #D   
...
def calcular_heroes_por_color_pelo ():
    ...
    print(f"No hair: {contador_no_hair}\n\
...
def listar_heroes_por_tipo_inteligencia ():
    ...
    print(f"Sin inteligencia: {lista_sin_inteligencia}\n\
good: {lista_good}\n\
